...
class QuestionsListState{
  ...
  QuestionsListState({this.context, this.questionsList, this.isAnswering, this.answeredLastQuestion = false, this.indexesCorrectQuestions = const []});

  QuestionsListState copyWith({BuildContext context, List<Question> questionsList, bool isAnswering, bool answeredLastQuestion, List<int> indexesCorrectQuestions}){
    return new QuestionsListState(
        ...
        indexesCorrectQuestions: indexesCorrectQuestions ?? this.indexesCorrectQuestions
    );
  }
